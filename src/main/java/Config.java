public class Config {
    ...
    public final static String SEED_CLASS_MAIN = "org.apache.fop.cli.Main";
    public final static String SEED_CLASS = "org/apache/fop/cli/Main";
    public final static String JAR_FILE = "fop.jar";
    ...
    public final static int MAX_ITERATIONS = 8000;
